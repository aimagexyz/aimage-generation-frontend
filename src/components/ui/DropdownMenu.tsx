...
function DropdownMenuShortcut(props: React.ComponentPropsWithoutRef<'span'>) {
  const { className, ...restProps } = props;
  return <span className={twMerge('ml-auto text-xs tracking-widest opacity-60', className)} {...restProps} />;
}
