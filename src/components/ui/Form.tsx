...
>(({ className, ...props }, ref) => {
  ...
  return (
    <Label ref={ref} className={twMerge(error && 'text-destructive', className)} htmlFor={formItemId} {...props} />
  );
});
...
const FormDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    ...
    return (
      <p ref={ref} id={formDescriptionId} className={twMerge('text-sm text-muted-foreground', className)} {...props} />
    );
  },
);
