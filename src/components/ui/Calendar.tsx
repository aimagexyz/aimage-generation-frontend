  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: twMerge('absolute inset-x-0 top-0 flex w-full items-center justify-between gap-1', defaultClassNames.nav),
        ...
        dropdown: twMerge('bg-popover absolute inset-0 opacity-0', defaultClassNames.dropdown),
        ...
        week_number_header: twMerge('w-[--cell-size] select-none', defaultClassNames.week_number_header),
        week_number: twMerge('text-muted-foreground select-none text-[0.8rem]', defaultClassNames.week_number),
        day: twMerge(
          'group/day relative aspect-square h-full w-full select-none p-0 text-center [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md',
          defaultClassNames.day,
        ),
        range_start: twMerge('bg-accent rounded-l-md', defaultClassNames.range_start),
        ...
        outside: twMerge('text-muted-foreground aria-selected:text-muted-foreground', defaultClassNames.outside),
